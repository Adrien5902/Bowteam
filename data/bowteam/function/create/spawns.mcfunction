give @s polar_bear_spawn_egg[entity_data={id:"minecraft:marker",Tags:["spawns"]},custom_name={text:"Map spawn",color:"aqua",italic:false}] 1
give @s ocelot_spawn_egg[entity_data={id:"minecraft:marker",Tags:["lobby"]},custom_name={text:"Lobby spawn",color:"gold",italic:false}] 1
